...
namespace BusinessBanking.DAL.Migrations
{
    ...
    [Migration("20230821083042_InitCreate")]
            ...
            modelBuilder.Entity("BusinessBanking.Domain.Entity.CustomerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CurrencyID = "840",
                            CustomerID = 1,
                            EndDate = new DateTime(2024, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6120),
                            OpenDate = new DateTime(2023, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6106)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CurrencyID = "417",
                            CustomerID = 1,
                            EndDate = new DateTime(2024, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6133),
                            OpenDate = new DateTime(2023, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6132)
                        },
                        new
                        {
                            ID = 3,
                            ...
                            CurrencyID = "417",
                            CustomerID = 1,
                            EndDate = new DateTime(2024, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6136),
                            OpenDate = new DateTime(2023, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6136)
                        },
                        new
                        {
                            ID = 4,
                            ...
                            CurrencyID = "643",
                            CustomerID = 2,
                            EndDate = new DateTime(2024, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6140),
                            OpenDate = new DateTime(2023, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6139)
                        },
                        new
                        {
                            ID = 5,
                            ...
                            CurrencyID = "643",
                            CustomerID = 2,
                            EndDate = new DateTime(2024, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6143),
                            OpenDate = new DateTime(2023, 8, 21, 14, 30, 42, 409, DateTimeKind.Local).AddTicks(6142)
                        });
                });
