...
namespace BusinessBanking.DAL.Migrations
{
    ...
    [Migration("20230814151931_AddTestAccounts")]
            ...
            modelBuilder.Entity("BusinessBanking.Domain.Entity.CustomerAccount", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CurrencyID = "840",
                            CustomerID = 1,
                            EndDate = new DateTime(2024, 8, 14, 21, 19, 31, 703, DateTimeKind.Local).AddTicks(1667),
                            OpenDate = new DateTime(2023, 8, 14, 21, 19, 31, 703, DateTimeKind.Local).AddTicks(1653)
                        },
                        new
                        {
                            ID = 2,
                            ...
                            CurrencyID = "417",
                            CustomerID = 1,
                            EndDate = new DateTime(2024, 8, 14, 21, 19, 31, 703, DateTimeKind.Local).AddTicks(1679),
                            OpenDate = new DateTime(2023, 8, 14, 21, 19, 31, 703, DateTimeKind.Local).AddTicks(1678)
                        },
                        new
                        {
                            ID = 3,
                            ...
                            CurrencyID = "417",
                            CustomerID = 1,
                            EndDate = new DateTime(2024, 8, 14, 21, 19, 31, 703, DateTimeKind.Local).AddTicks(1687),
                            OpenDate = new DateTime(2023, 8, 14, 21, 19, 31, 703, DateTimeKind.Local).AddTicks(1686)
                        });
                });
